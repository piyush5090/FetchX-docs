...
```bash
curl "https://fetchx-zi49.onrender.com/search?query=mountains&type=images" \
...
```bash
curl "https://fetchx-zi49.onrender.com/metadata/all/images?query=nature" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl "https://fetchx-zi49.onrender.com/metadata/all/videos?query=ocean" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
...
```bash
curl "https://fetchx-zi49.onrender.com/metadata/pexels/images?query=cats" \
  -H "Authorization: Bearer YOUR_API_KEY"
```
